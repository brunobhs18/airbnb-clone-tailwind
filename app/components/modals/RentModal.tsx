...
const RentModal = () => {
    ...
    let bodyContent = (
        <div className="flex flex-col gap-8">
            <Heading 
                title="Qual desses descreve melhor o seu lugar?"
    ...
    if (step == STEPS.LOCATION){
        bodyContent = (
            <div className="flex flex-col gap-8">
                <Heading title="Onde é a sua localização?"
                    subtitle="Ajude-nos a te encontrar!"
                />
                <CountrySelect 
                    value={location}
    ...
    if (step == STEPS.INFO) {
        bodyContent =(
            <div className="flex flex-col gap-8">
                <Heading title="Compartilhe algumas informações sobre o local"
    ...
    if (step == STEPS.IMAGES) {
        bodyContent = (
            <div className="flex flex-col gap-8">
                <Heading title="Adicione a foto do seu local"
                    subtitle="Mostre para os seus hospedes curtirem!"
                />
                <ImageUpload 
                    value={imageSrc}
    ...
    if (step == STEPS.DESCRIPTION){
        bodyContent = (
            <div className="flex flex-col gap-8">
                <Heading title="Como você descreve o seu local?"
                    subtitle="Descrições curtas e bem feitas funcionam melhor!"
                />
                <Input id="title"
                    label="Título"
                    disabled={isLoading}
    ...
    if (step == STEPS.PRICE){
        bodyContent = (
            <div className="flex flex-col gap-8">
                <Heading title="Agora, diga o valor"
